    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            public void onClick(@NonNull View view) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://social-login-2.flycricket.io/privacy.html")));
            }
        };
        ...
        ClickableSpan clickableSpan1 = new ClickableSpan() {
            @Override
            public void onClick(@NonNull View view) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://social-login-2.flycricket.io/terms.html")));
            }
        };
